...
export function CollectionSlide() {
  ...
  return (
    <div
      className={
        'relative min-w-0 flex-[0_0_100%] rounded-[0.521vw] overflow-hidden last:ml-[0.26vw]'
      }
    >
      {isMobile ? (
        <Image
      ...
      >
        ...
        >
          <div className={'col-span-3 flex flex-col gap-[2.353vw] lg:!gap-[0.781vw]'}>
            ...
            >
              The ZkNoid Avatars collection is the first of its kind. The holders of Zknode NFTs not
              only have access to the image, but also the personality of a reptilian fantasy world.
